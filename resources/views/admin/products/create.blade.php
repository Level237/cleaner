...
@section('header')
    ...
    <div class="flex justify-between items-center w-full">
        <h2 class="text-3xl font-bold text-gray-900 tracking-tight">Créer un produit</h2>
    </div>
@endsection
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="sku" id="sku" value="{{ old('sku') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <textarea name="short_description" id="short_description" rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">{{ old('short_description') }}</textarea>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="tea_family" id="tea_family" value="{{ old('tea_family') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="origin" class="block text-sm font-medium text-gray-700">Origine</label>
                            <input type="text" name="origin" id="origin" value="{{ old('origin') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="harvest" class="block text-sm font-medium text-gray-700">Récolte</label>
                            <input type="text" name="harvest" id="harvest" value="{{ old('harvest') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="caffeine_level" class="block text-sm font-medium text-gray-700">Niveau de caféine</label>
                            <input type="text" name="caffeine_level" id="caffeine_level" value="{{ old('caffeine_level') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="brewing_temp_celsius" class="block text-sm font-medium text-gray-700">Temp. d'infusion (°C)</label>
                            <input type="number" name="brewing_temp_celsius" id="brewing_temp_celsius" value="{{ old('brewing_temp_celsius') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                        <div>
                            <label for="brewing_time" class="block text-sm font-medium text-gray-700">Temps d'infusion</label>
                            <input type="text" name="brewing_time" id="brewing_time" value="{{ old('brewing_time') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="stock_status" id="stock_status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                ...
                                <option value="out_of_stock" {{ old('stock_status') == 'out_of_stock' ? 'selected' : '' }}>Rupture</option>
                        ...
                        <div>
                            ...
                            <input type="number" name="stock_quantity" id="stock_quantity" value="{{ old('stock_quantity') }}" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <select name="primary_category_id" id="primary_category_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" {{ old('primary_category_id') == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <div class="space-y-2 max-h-48 overflow-y-auto border border-gray-200 rounded-md p-3">
                                @foreach($collections as $collection)
                                    <div class="flex items-center">
                                        <input type="checkbox" name="collections[]" id="collection_{{ $collection->id }}" value="{{ $collection->id }}" {{ in_array($collection->id, old('collections', [])) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
